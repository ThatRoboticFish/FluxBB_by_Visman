...
function get_useragent_names(string $usrag)
{
	...
	// Browser detection
	$browsers = array('Opera', 'Avant', 'Maxthon', 'Edg', 'MSIE', 'OPR', 'YaBrowser', 'Chromium', 'Vivaldi', 'Chrome', 'Arora', 'Epiphany', 'Galeon', 'iCab', 'Konqueror', 'Safari', 'Flock', 'Iceweasel', 'RetroZilla', 'SeaMonkey', 'Netscape', 'K-Meleon', 'Firefox', 'PaleMoon', 'Camino', 'Trident');
